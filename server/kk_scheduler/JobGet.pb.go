...
// 	protoc        (unknown)
// source: kk_scheduler/JobGet.proto
...
func (x *JobGet) Reset() {
	*x = JobGet{}
	mi := &file_kk_scheduler_JobGet_proto_msgTypes[0]
...
func (x *JobGet_Input) Reset() {
	*x = JobGet_Input{}
	mi := &file_kk_scheduler_JobGet_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *JobGet_Output) Reset() {
	*x = JobGet_Output{}
	mi := &file_kk_scheduler_JobGet_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_kk_scheduler_JobGet_proto protoreflect.FileDescriptor

const file_kk_scheduler_JobGet_proto_rawDesc = "" +
	"\n" +
	"\x19kk_scheduler/JobGet.proto\x12\fkk_scheduler\x1a\x16kk_scheduler/Job.proto\x1a&kk_go_kit/common_pb/extend_field.proto\"\x8e\x01\n" +
	"\x06JobGet\x1aS\n" +
	"\x05Input\x12'\n" +
...
var file_kk_scheduler_JobGet_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_kk_scheduler_JobGet_proto_goTypes = []any{
	(*JobGet)(nil),        // 0: kk_scheduler.JobGet
	(*JobGet_Input)(nil),  // 1: kk_scheduler.JobGet.Input
	(*JobGet_Output)(nil), // 2: kk_scheduler.JobGet.Output
	(*PBJob)(nil),         // 3: kk_scheduler.PBJob
}
var file_kk_scheduler_JobGet_proto_depIdxs = []int32{
	3, // 0: kk_scheduler.JobGet.Output.Job:type_name -> kk_scheduler.PBJob
...
func init() { file_kk_scheduler_JobGet_proto_init() }
func file_kk_scheduler_JobGet_proto_init() {
	if File_kk_scheduler_JobGet_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kk_scheduler_JobGet_proto_rawDesc), len(file_kk_scheduler_JobGet_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kk_scheduler_JobGet_proto_goTypes,
		DependencyIndexes: file_kk_scheduler_JobGet_proto_depIdxs,
		MessageInfos:      file_kk_scheduler_JobGet_proto_msgTypes,
	}.Build()
	File_kk_scheduler_JobGet_proto = out.File
	file_kk_scheduler_JobGet_proto_goTypes = nil
	file_kk_scheduler_JobGet_proto_depIdxs = nil
}
