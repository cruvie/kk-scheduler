...
// 	protoc        (unknown)
// source: kk_scheduler/JobEnable.proto
...
func (x *JobEnable) Reset() {
	*x = JobEnable{}
	mi := &file_kk_scheduler_JobEnable_proto_msgTypes[0]
...
func (x *JobEnable_Input) Reset() {
	*x = JobEnable_Input{}
	mi := &file_kk_scheduler_JobEnable_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *JobEnable_Output) Reset() {
	*x = JobEnable_Output{}
	mi := &file_kk_scheduler_JobEnable_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_kk_scheduler_JobEnable_proto protoreflect.FileDescriptor

const file_kk_scheduler_JobEnable_proto_rawDesc = "" +
	"\n" +
	"\x1ckk_scheduler/JobEnable.proto\x12\fkk_scheduler\x1a&kk_go_kit/common_pb/extend_field.proto\"j\n" +
	"\tJobEnable\x1aS\n" +
	"\x05Input\x12'\n" +
...
var file_kk_scheduler_JobEnable_proto_goTypes = []any{
	(*JobEnable)(nil),        // 0: kk_scheduler.JobEnable
	(*JobEnable_Input)(nil),  // 1: kk_scheduler.JobEnable.Input
	(*JobEnable_Output)(nil), // 2: kk_scheduler.JobEnable.Output
}
var file_kk_scheduler_JobEnable_proto_depIdxs = []int32{
...
func init() { file_kk_scheduler_JobEnable_proto_init() }
func file_kk_scheduler_JobEnable_proto_init() {
	if File_kk_scheduler_JobEnable_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kk_scheduler_JobEnable_proto_rawDesc), len(file_kk_scheduler_JobEnable_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kk_scheduler_JobEnable_proto_goTypes,
		DependencyIndexes: file_kk_scheduler_JobEnable_proto_depIdxs,
		MessageInfos:      file_kk_scheduler_JobEnable_proto_msgTypes,
	}.Build()
	File_kk_scheduler_JobEnable_proto = out.File
	file_kk_scheduler_JobEnable_proto_goTypes = nil
	file_kk_scheduler_JobEnable_proto_depIdxs = nil
}
