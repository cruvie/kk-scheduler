...
// 	protoc        (unknown)
// source: kk_scheduler/JobSetSpec.proto
...
func (x *JobSetSpec) Reset() {
	*x = JobSetSpec{}
	mi := &file_kk_scheduler_JobSetSpec_proto_msgTypes[0]
...
func (x *JobSetSpec_Input) Reset() {
	*x = JobSetSpec_Input{}
	mi := &file_kk_scheduler_JobSetSpec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *JobSetSpec_Output) Reset() {
	*x = JobSetSpec_Output{}
	mi := &file_kk_scheduler_JobSetSpec_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_kk_scheduler_JobSetSpec_proto protoreflect.FileDescriptor

const file_kk_scheduler_JobSetSpec_proto_rawDesc = "" +
	"\n" +
	"\x1dkk_scheduler/JobSetSpec.proto\x12\fkk_scheduler\x1a&kk_go_kit/common_pb/extend_field.proto\"\x86\x01\n" +
	"\n" +
	"JobSetSpec\x1an\n" +
	"\x05Input\x12'\n" +
...
var file_kk_scheduler_JobSetSpec_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_kk_scheduler_JobSetSpec_proto_goTypes = []any{
	(*JobSetSpec)(nil),        // 0: kk_scheduler.JobSetSpec
	(*JobSetSpec_Input)(nil),  // 1: kk_scheduler.JobSetSpec.Input
	(*JobSetSpec_Output)(nil), // 2: kk_scheduler.JobSetSpec.Output
}
var file_kk_scheduler_JobSetSpec_proto_depIdxs = []int32{
...
func init() { file_kk_scheduler_JobSetSpec_proto_init() }
func file_kk_scheduler_JobSetSpec_proto_init() {
	if File_kk_scheduler_JobSetSpec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_kk_scheduler_JobSetSpec_proto_rawDesc), len(file_kk_scheduler_JobSetSpec_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_kk_scheduler_JobSetSpec_proto_goTypes,
		DependencyIndexes: file_kk_scheduler_JobSetSpec_proto_depIdxs,
		MessageInfos:      file_kk_scheduler_JobSetSpec_proto_msgTypes,
	}.Build()
	File_kk_scheduler_JobSetSpec_proto = out.File
	file_kk_scheduler_JobSetSpec_proto_goTypes = nil
	file_kk_scheduler_JobSetSpec_proto_depIdxs = nil
}
