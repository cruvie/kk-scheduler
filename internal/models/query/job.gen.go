...
func newJob(db *gorm.DB, opts ...gen.DOOption) job {
	...
	_job.ServiceName = field.NewString(tableName, "service_name")
	_job.FuncName = field.NewString(tableName, "func_name")
	_job.EntryID = field.NewInt32(tableName, "entry_id")
...
func (j *job) updateTableName(table string) *job {
	...
	j.ServiceName = field.NewString(table, "service_name")
	j.FuncName = field.NewString(table, "func_name")
	j.EntryID = field.NewInt32(table, "entry_id")
