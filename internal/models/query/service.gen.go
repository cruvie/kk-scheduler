...
func newService(db *gorm.DB, opts ...gen.DOOption) service {
	...
	_service.Target = field.NewString(tableName, "target")
	_service.AuthToken = field.NewString(tableName, "auth_token")
...
func (s *service) updateTableName(table string) *service {
	...
	s.AuthToken = field.NewString(table, "auth_token")
...
func (s *service) fillFieldMap() {
	...
	s.fieldMap["auth_token"] = s.AuthToken
}
